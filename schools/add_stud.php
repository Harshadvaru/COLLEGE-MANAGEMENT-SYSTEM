                ...
                <h3 class="text">Welcome <?php echo $_SESSION["tname"]; ?></h3><br><hr><br>
					...
					<?php
						if(isset($_POST["submit"]))
						{
							...
							{
								$sq="insert into student(id,rno,name,fname,dob,gen,pho,mail,addr,sclass,ssec,simg,tid) values('{$_POST["rno"]}','{$_POST["name"]}','{$_POST["fname"]}','{$edate}','{$_POST["gen"]}','{$_POST["pho"]}','{$_POST["mail"]}','{$_POST["addr"]}','{$_POST["sclass"]}','{$_POST["ssec"]}','{$target_file}','{$_SESSION["tid"]}')";
